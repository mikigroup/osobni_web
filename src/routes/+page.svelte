...
<div class="container mx-auto">
	<article>
		<div class="grid justify-items-center mt-10 md:px-10">
			<div
				class="bg grid shadow-2xl justify-center border-2 border-neutral-600">
				<div class="grid grid-rows-4">
					<div class="grid justify-center mt-5">
						<img
							class="opacity-90 spock w-24 md:w-32 animate__animated animate__fadeIn animate__delay-2s"
							src="hand-spock.svg"
							alt="miki spock" />
					</div>
					<div
